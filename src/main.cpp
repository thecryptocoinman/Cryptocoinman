...
const string strMessageMagic = "CryptoCoinMan Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CryptoCoinMan", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1469107507, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "UK nuclear submarine collides with merchant vessel off Gibraltar";
        CTransaction txNew;
        txNew.nTime = 1469107507;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1469107507;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1711038 : 1711038;
        ...
        assert(block.hashMerkleRoot == uint256("0x5298627b1c01d80576a048635ad16c1f7110dbd3b85c871c6ca2ee1cd3d04db1"));
...
unsigned char pchMessageStart[4] = { 0x99, 0xed, 0xf7, 0x80 };
